...
public class ElectricBlastFurnaceInfo extends MultiblockInfoPage {
	...
	public MultiblockShapeInfo getMatchingShapes(int extent) {
		return MultiblockShapeInfo.builder()
				...
				.where('H', PlaceholderType.MUFFLER ,GATileEntities.MUFFLER_HATCH[0], EnumFacing.UP)
				...
				.where('D', PlaceholderType.OUTPUT_HATCH, MetaTileEntities.FLUID_EXPORT_HATCH[0], EnumFacing.SOUTH)
