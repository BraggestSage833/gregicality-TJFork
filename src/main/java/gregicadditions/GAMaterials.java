...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final IngotMaterial SamariumMagnetic = new IngotMaterial(978, "samarium_magnetic", 16777215, MaterialIconSet.MAGNETIC, 2, ImmutableList.of(new MaterialStack(Neodymium, 1L)), EXT2_METAL | gregtech.api.unification.material.type.SolidMaterial.MatFlags.GENERATE_LONG_ROD, (Element)null, 1347);
