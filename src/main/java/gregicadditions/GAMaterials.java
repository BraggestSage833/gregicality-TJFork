...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final IngotMaterial CosmicNeutronium = new IngotMaterial(671,"cosmic_neutronium",0x323232,MaterialIconSet.COSMIC_NEUTRONIUM,7,of(new MaterialStack(Neutronium, 1)), CORE_METAL | DISABLE_DECOMPOSITION,null,14100);
